    ...
    >
      ...
      <div className="grid gap-10 p-10 mt-20 sm:grid-cols-2 nm-inset-gray-900 rounded-xl">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="sm:w-[30vw] p-5 nm-flat-gray-900 rounded-xl cursor-pointer hover:scale-105 transition-all "
        >
        ...
        <a
          href="https://netflix-clone-mu-lyart.vercel.app/login"
          target="_blank"
          rel="noreferrer"
          className="sm:w-[30vw] p-5 nm-flat-gray-900 rounded-xl cursor-pointer hover:scale-105 transition-all"
        >
        ...
        <a
          href="https://new-portfolio-ashy.vercel.app/"
          target="_blank"
          rel="noreferrer"
          className="sm:w-[30vw] p-5 nm-flat-gray-900 rounded-xl cursor-pointer hover:scale-105 transition-all"
        >
        ...
        <a
          href="https://expo.dev/@akshitagrawal/uber-clone?serviceType=classic&distributiion=expo-go"
          target="_blank"
          rel="noreferrer"
          className="sm:w-[30vw] p-5 nm-flat-gray-900 rounded-xl cursor-pointer hover:scale-105 transition-all"
        >
